...
def return_total_money_volume(model):
	return model.final_total_money_volume

def return_percentage_change_total_money_volume(model):
	return model.percentage_change_total_money_volume
...
class MyModel(Model):
	...
	def __init__(self, NSuppliers, NDemanders, InitialMoney, prop_hel, prop_expand, prop_rec):
		...
		self.percentage_change_total_money_volume = 0.0
		
		self.data_collector = DataCollector(
			model_reporters = {"Percentage Change of Total Volume of all Monies": return_percentage_change_total_money_volume})
	...
	def step(self):
		...
		#calculating initial total money volume number.
		self.initial_total_money_volume = np.sum(self.initial_volume_of_each_money)
		...
		#total, absolute sum of all monies in circulation.
		self.final_total_money_volume = np.sum(self.market.volume_of_each_money)
		#calculating percentage change of total money volume.
		self.percentage_change_total_money_volume = (self.final_total_money_volume / self.initial_total_money_volume)
		self.percentage_change_total_money_volume = self.percentage_change_total_money_volume - 1
		self.percentage_change_total_money_volume = (self.percentage_change_total_money_volume * 100)
		...
		print("FINAL TOTAL MONEY VOLUME: ", self.final_total_money_volume)
		print()
		print("PERCENTAGE CHANGE OF TOTAL MONEY VOLUME: ", self.percentage_change_total_money_volume, "%")
...
for i in range(50):
	model.step()
percentage_change_total_money_volume = model.data_collector.get_model_vars_dataframe()
percentage_change_total_money_volume.plot()
plt.show()